"""ConversationStore Facade — 替代原 conversation_store 单例。

委托 ConversationRepository，保留 ConversationStore 方法签名（消费者零改动）。
...
class ConversationFacade:
    """委托 ConversationRepository，接口与 ConversationStore 一致。"""
