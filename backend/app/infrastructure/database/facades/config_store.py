"""LumiConfigStore Facade — 替代原 lumi_config_store 单例。

委托 ConfigRepository，保留 LumiConfigStore 方法签名（消费者零改动）。
- 敏感字段（api_key/secret_key）自动 AES 加解密
- list_all() 中加密字段返回 "***"
"""
import asyncio
...
class LumiConfigFacade:
    """委托 ConfigRepository，接口与 LumiConfigStore 一致。"""
