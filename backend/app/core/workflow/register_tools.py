...
async def _memory_search(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.search] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_build_context(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.build_context] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_update_knowledge(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        engine = get_memory_engine()
        if engine is None:
            return WorkflowTaskResult(success=False, error="Memory engine not initialized")
        ...
        logger.error("[Workflow:memory.update_knowledge] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_update_profile(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.update_profile] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_append_daily(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.append_daily] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_get_daily(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.get_daily] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_list_dailies(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.list_dailies] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_vector_rebuild(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.vector_rebuild] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_promote_conversation_facts(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.promote_conversation_facts] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_clear_facts(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.clear_facts] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_list_facts(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.list_facts] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_create_fact(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.create_fact] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_update_fact(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.update_fact] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_delete_fact(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.delete_fact] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_get_summary(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.get_summary] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_update_summary(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.update_summary] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_get_knowledge(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.get_knowledge] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_get_profile(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.get_profile] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
...
async def _memory_distill(args: dict[str, Any]) -> WorkflowTaskResult:
    ...
    try:
        ...
        logger.error("[Workflow:memory.distill] Failed: {}", str(e), exc_info=True)
        return WorkflowTaskResult(success=False, error=str(e))
