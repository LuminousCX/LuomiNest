...
const themeMap: Record<string, ThemeConfig> = {
  ...
  Search: { colorVar: '--task-sky', animClass: 'anim-shimmer' },
  ...
  GraduationCap: { colorVar: '--task-sky', animClass: 'anim-float' },
  ...
  PenTool: { colorVar: '--task-sky', animClass: 'anim-float' },
  ...
  Scale: { colorVar: '--task-sky', animClass: 'anim-float' },
